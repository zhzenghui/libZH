...
- (void) pushViewController:(UIViewController *)viewController
{
    ...
    [UIView animateWithDuration:kAnimationDuration delay:kAnimationDelay options:0 animations:^{
        ...
        if ( iOS7) {
            ...
            [self currentViewController].view.frame = CGRectMake(-100, 20, screenWidth, screenHeight);
        }
...
{
    viewController.view.frame = CGRectMake(0, screenHeight, screenWidth, screenHeight);
    viewController.view.autoresizingMask =  UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth;
    [viewController willMoveToParentViewController:self];
    [self addChildViewController:viewController];
    [self.view addSubview:viewController.view];
...
- (void) popModelViewController
{
    ...
    [UIView animateWithDuration:kAnimationDuration delay:kAnimationDelay options:0 animations:^{
        ...
        currentVC.view.frame = CGRectMake(0, screenHeight, screenWidth, screenHeight);
...
- (void) popViewController
{
    ...
    [UIView animateWithDuration:kAnimationDuration delay:kAnimationDelay options:0 animations:^{
        ...
        if ( iOS7) {
            ...
            previousVC.view.frame = CGRectMake(0, 20, screenWidth, screenHeight);
        }
